...
- Build and maintain CI/CD pipelines (GitHub Actions, Argo CD).
- Manage cloud infrastructure as code.

Requirements
- 3+ years in a platform, DevOps, or SRE role.
- Production experience with Kubernetes and Docker.
- Strong with Terraform and AWS.
- Fluent in at least one of Python, Go, or Bash.
- Experience owning CI/CD for a multi-team codebase.
