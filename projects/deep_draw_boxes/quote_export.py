...
_LABELS = {"material": "Material", "labor": "Fabrication labor", "cover": "Cover", "nutplates": "Nutplates"}
...
def to_pdf(part_no, box, height_in, quote, fig, cover_type, nutplate_pattern, estimate=None) -> bytes:
